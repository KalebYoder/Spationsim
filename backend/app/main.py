...
from .routers import auth, nations, territories, facilities, military, probes, economy, chat, mail, diplomacy, events, trade, probe_market, tutorial, notifications
...
app.include_router(probe_market.router)
